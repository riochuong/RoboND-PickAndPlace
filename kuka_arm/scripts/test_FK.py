...
## T4_5
T4_5 = Matrix([[cos(q5),                        -sin(q3),             0,                  a4],
...
## T5_6
T5_6 = Matrix([[cos(q6),                        -sin(q3),             0,                  a5],
...
print("T0_1 = ", T0_1.evalf(subs=sub_dict))
print("T0_2 = ", T0_2.evalf(subs=sub_dict))
print("T0_3 = ", T0_3.evalf(subs=sub_dict))
print("T0_4 = ", T0_4.evalf(subs=sub_dict))
print("T0_5 = ", T0_5.evalf(subs=sub_dict))
print("T0_6 = ", T0_6.evalf(subs=sub_dict))
print("T0_G = ", T0_G.evalf(subs=sub_dict))
